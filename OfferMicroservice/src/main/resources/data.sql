...
insert into Employee(id,name,gender,age) values(1,'user123','male',21);
insert into Employee(id,name,gender,age) values(2,'user234','other',31);
insert into Employee(id,name,gender,age) values(3,'user345','female',24);

insert into Offer(id,name,category,emp_id,likes) values(1,'offer 1' ,'electronics',3,300);
